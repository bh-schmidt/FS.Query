    ...
    public static class JoinByExpression
    {
        ...
        private static object BuildInternal(Expression expression, DbSettings dbSettings, ITypedSource firstSource, ITypedSource secondSource, ParameterExpression[] parametersExpressions)
        {
            if (expression is BinaryExpression binaryExpression)
            {
                ...
                var stringBuilder = BuildValue(dictionary, binaryExpression, dbSettings);
        ...
        private static object BuildValue(Dictionary<string, (ITypedSource, ObjectMap)> dictionary, Expression expression, DbSettings dbSettings)
        {

            if (expression is BinaryExpression binaryExpression)
            {
                var leftBuilder = BuildValue(dictionary, binaryExpression.Left, dbSettings);
                var rightBuilder = BuildValue(dictionary, binaryExpression.Right, dbSettings);
